...
assign a percentage match based on key criteria, and pinpoint all the missing keywords in BOLD accurately.
resume:{text}
description:{job_description}
I want the response in one single string having the structure
{{"Job Description Match":"%","Missing Keywords":"","Experience":""}}
"""
